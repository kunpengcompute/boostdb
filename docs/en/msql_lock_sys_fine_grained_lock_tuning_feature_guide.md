# MySQL Lock-sys Fine-Grained Lock Optimization Feature Guide

<!-- md-trans-meta sourceCommit=2f6e0d8c590d432e22d4361f9d2a3759f3fda286 translatedAt=2026-09-16T08:46:18.364Z pushedAt=2026-09-16T09:30:10.027Z -->

## Feature Description<a name="EN-US_TOPIC_0000002602100002"></a>

### Introduction<a name="EN-US_TOPIC_0000002602100003"></a>

This document describes how to install and use the MySQL Lock-sys fine-grained lock optimization feature on a Kunpeng server.

In MySQL online transaction processing (OLTP) scenarios with high-concurrency read/write operations, lock management in the InnoDB transaction system can easily become a hotspot, which may cause global lock contention. This document uses Percona-Server as an example to describe how to optimize the InnoDB transaction system on a Kunpeng server to improve performance in high-concurrency write scenarios.
...
**Table 1** Hardware requirement<a id="hardware_requirement"></a>
...
|Percona|Percona-Server|5.7.44-53|See [BoostDB-Percona Installation Guide](./boostdb-percona-install.md).|
