...
## 使用约束<a name="ZH-CN_TOPIC_0000002550184563"></a>
...
## FAQ<a name="ZH-CN_TOPIC_0000002518704728"></a>
...
|发布日期|修订记录|
|--|--|
|2024-11-28|第四次正式发布。新增FAQ，新增MySQL并行查询优化应用场景常见问题。|
|2023-07-04|第三次正式发布。新增使用约束。|
